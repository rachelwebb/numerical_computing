...
You can test this function on the image \li{cameraman.png}, which appears in Figure \ref{fig:cameraman}.
...
Test this function on \li{cameraman.png}.
\end{enumerate}
\end{problem}
...
\end{pmatrix}.
\]
We can use the function \li{Filter} that we wrote in Problem \ref{prob:filter} to apply a Gaussian blur to the image \li{cameraman.png}. 
...
When the Sobel filter is applied to \li{cameraman.png}, we get the image in Figure \ref{fig:cameraman_edges}. 
